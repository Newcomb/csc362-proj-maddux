...
<body>
    ...
    include "drop_down_options_spec.php";
    ?>
...
?>
            <form method=POST>
                <?php drop_down_options_spec('/DML/SelectPokemastersOwnedPokemon.sql', $_GET['pokeID'] , 0, $sql_path, 'Choose a Pokemaster', 'pokemasterID'); ?>
